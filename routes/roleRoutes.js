...
router.get('/:id/hierarchy',                    auth, checkPermission('roles:read'),                            roleController.getRoleHierarchy);
router.get('/:id/permissions',                  auth, checkPermission('roles:read'),                            roleController.getRolePermissions);
